...
- Recommendation: workflow inspiration only unless a component-level legal/technical review approves reuse. Lango should not adopt Odoo as a second application framework.
...
- Recommendation: behavioral inspiration only; do not copy GPL code into Lango without legal review.
...
- Zod and Drizzle already match Lango's validation/data stack; do not introduce a second ORM/workflow engine merely for this addon.
...
Build the hostel domain natively in Lango. External school ERPs are valuable references but are too broad and copyleft/framework-coupled to embed. The competitive advantage should come from reliable bed history, supervision workflows, privacy, guardian participation, facilities readiness and transparent capacity forecasting—not decorative dashboards.

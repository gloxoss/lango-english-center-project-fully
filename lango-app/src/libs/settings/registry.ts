...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  {
    key: 'attendance.consecutiveAbsenceThreshold',
    label: 'Seuil d\'absences consécutives',
    description: 'Nombre de jours d\'enseignement consécutifs d\'absence qui déclenche un signalement.',
    namespace: 'attendance',
    valueSchema: z.number().int().min(2).max(30),
    defaultValue: 3,
    scope: 'tenant',
    sensitivity: 'internal',
    requiredPermission: 'settings.attendance.manage',
  ...
  {
    key: 'attendance.repeatedLateThreshold',
    label: 'Seuil de retards répétés',
    description: 'Nombre de retards dans le mois qui déclenche un signalement.',
    namespace: 'attendance',
    valueSchema: z.number().int().min(2).max(60),
    defaultValue: 5,
    scope: 'tenant',
    sensitivity: 'internal',
    requiredPermission: 'settings.attendance.manage',

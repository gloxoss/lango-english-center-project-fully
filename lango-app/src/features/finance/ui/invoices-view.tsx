        ...
        >
          <Link href={`/${locale}/dashboard/finance/allocations`}>
            <Button
              ...
              size="sm"
              className="
                h-9 gap-1.5 rounded-xl border-slate-200 bg-white text-xs
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    <span className="
                      font-mono text-[11px] font-semibold text-[#2487B8]
                    "
                    >
                      {inv.invoiceNumber}
                    </span>
          ...
          >
            ...
            >
              ...
              <Button
                ...
                className="
                  ml-auto h-8 gap-1 rounded-xl border-slate-200 text-[11px]
                "
              >

  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-[#16212B] tracking-tight">{t('refundsTitle')}</h1>
          <p className="text-xs text-slate-500 mt-1">{t('refundsSubtitle', { count: refunds.length })}</p>
        </div>
        {can('finance.manage') && (

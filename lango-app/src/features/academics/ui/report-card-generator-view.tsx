...
type ReportCard = {
  ...
  subjects: { subjectId: string; subjectName: string; average: number; assessmentCount: number }[];
    ...
    <div className="space-y-6 max-w-[1600px] mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Bulletin réel, calculé à partir des notes saisies (moyenne marocaine /20).</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-6">
          ...
          <Card className="p-5 bg-white rounded-2xl border border-slate-200/80 shadow-2xs">
            ...
            {!loading && !card && <p className="text-xs text-slate-500">Aucune note enregistrée pour cet élève.</p>}
            {!loading && card && (
        ...
        <div className="space-y-4">
          {card
            ? (
                <Card className="p-8 bg-white rounded-2xl border border-slate-200/80 shadow-md space-y-6 text-xs">
            ...
            : (
                <Card className="p-8 bg-white rounded-2xl border border-slate-200/80 shadow-md flex items-center justify-center text-xs text-slate-400 min-h-[300px]">
                  <div className="text-center space-y-2">
                    ...
                    <p>Sélectionnez un élève avec des notes pour voir son bulletin.</p>
                  </div>
                </Card>
              )}
        </div>

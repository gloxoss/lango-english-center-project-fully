  ...
  const schoolNavItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { label: 'Politiques Académiques', href: `/${locale}/dashboard/academics/grading/policies`, permission: 'grading.manage' },
        ...
        { label: tNav('settings-attendance'), href: `/${locale}/dashboard/settings/attendance`, permission: 'settings.attendance.manage' },
  ...
  const parentPortalNav: NavItem[] = [
    {
      ...
      subItems: [
        ...
        { label: tNav('parentGrades'), href: `/${locale}/dashboard/parent/grades` },

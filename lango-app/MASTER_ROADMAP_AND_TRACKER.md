...
| **Phase 3** | **Core Teaching & Learning** | 100% | 🟢 PASSED | **Done**: Attendance engine, QR scanning, Moroccan `/20` grading formula, Assignments, Online exams, Question Bank Admin UI (exam-scoped CRUD + MCQ builder, sidebar linked under Matières & Classes). **Note (2026-08-14)**: the richer "online-examinations" addon was retired 2026-08-13; the live online-exam feature is the legacy migration-`0025` MCQ flow, whose UI was de-mocked in M13. |

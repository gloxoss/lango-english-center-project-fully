...
END $$;--> statement-breakpointDO $$ BEGIN
 CREATE TYPE "public"."attendance_excuse_status" AS ENUM('pending', 'approved', 'rejected');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 CREATE TYPE "public"."attendance_flag_status" AS ENUM('OPEN', 'RESOLVED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 CREATE TYPE "public"."attendance_flag_type" AS ENUM('UNJUSTIFIED_ABSENCE', 'REPEATED_LATE', 'CONSECUTIVE_ABSENCE');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
...
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointCREATE TABLE IF NOT EXISTS "announcement_reads" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"announcement_id" uuid NOT NULL,
	"user_id" text NOT NULL,
	"read_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "announcement_reads_announcement_id_user_id_unique" UNIQUE("announcement_id","user_id")
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "announcements" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "assignment_submissions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "assignments" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "attendance_excuses" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	"student_id" text NOT NULL,
	"date" date NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "attendance_flags" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	"student_id" text NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "attendance_summary" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	"student_id" text NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "cndp_filings" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "inquiries" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "inquiry_follow_ups" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	...
	"created_by_id" text,
	"created_at" timestamp DEFAULT now() NOT NULL
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "meeting_slots" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "online_exam_answers" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"attempt_id" uuid NOT NULL,
	"question_id" uuid NOT NULL,
	"selected_option_id" uuid
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "online_exam_attempts" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "online_exam_question_options" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"question_id" uuid NOT NULL,
	"option_text" text NOT NULL,
	"is_correct" boolean DEFAULT false NOT NULL
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "online_exam_questions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	"online_exam_id" uuid NOT NULL,
...
);--> statement-breakpointCREATE TABLE IF NOT EXISTS "online_exams" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"tenant_id" uuid NOT NULL,
	"class_subject_id" uuid NOT NULL,
	"title" varchar(255) NOT NULL,
	...
	"created_by_id" text NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL
);--> statement-breakpointALTER TABLE "attendance" ADD COLUMN IF NOT EXISTS "subject_id" uuid;--> statement-breakpointALTER TABLE "attendance" ADD COLUMN IF NOT EXISTS "period" integer DEFAULT 1 NOT NULL;--> statement-breakpointALTER TABLE "attendance" ADD COLUMN IF NOT EXISTS "academic_year_id" uuid;--> statement-breakpointALTER TABLE "attendance" ADD COLUMN IF NOT EXISTS "academic_term_id" uuid;--> statement-breakpointALTER TABLE "attendance" ADD COLUMN IF NOT EXISTS "is_voided" boolean DEFAULT false NOT NULL;--> statement-breakpointALTER TABLE "attendance" ADD COLUMN IF NOT EXISTS "void_reason" text;--> statement-breakpointALTER TABLE "user" ADD COLUMN IF NOT EXISTS "failed_login_count" integer DEFAULT 0 NOT NULL;--> statement-breakpointALTER TABLE "user" ADD COLUMN IF NOT EXISTS "locked_until" timestamp;--> statement-breakpointALTER TABLE "user" ADD COLUMN IF NOT EXISTS "must_change_password" boolean DEFAULT false NOT NULL;--> statement-breakpointDO $$ BEGIN
...
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 ALTER TABLE "attendance_excuses" ADD CONSTRAINT "attendance_excuses_tenant_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 ALTER TABLE "attendance_excuses" ADD CONSTRAINT "attendance_excuses_student_id_fk" FOREIGN KEY ("student_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 ALTER TABLE "attendance_excuses" ADD CONSTRAINT "attendance_excuses_reviewed_by_id_fk" FOREIGN KEY ("reviewed_by_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 ALTER TABLE "attendance_flags" ADD CONSTRAINT "attendance_flags_tenant_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 ALTER TABLE "attendance_flags" ADD CONSTRAINT "attendance_flags_student_id_fk" FOREIGN KEY ("student_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 ALTER TABLE "attendance_summary" ADD CONSTRAINT "attendance_summary_tenant_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
 ALTER TABLE "attendance_summary" ADD CONSTRAINT "attendance_summary_student_id_fk" FOREIGN KEY ("student_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointDO $$ BEGIN
...
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpointCREATE INDEX IF NOT EXISTS "attendance_excuses_student_idx" ON "attendance_excuses" USING btree ("student_id");--> statement-breakpointCREATE INDEX IF NOT EXISTS "attendance_excuses_tenant_idx" ON "attendance_excuses" USING btree ("tenant_id");--> statement-breakpointCREATE INDEX IF NOT EXISTS "attendance_flags_student_tenant_idx" ON "attendance_flags" USING btree ("tenant_id","student_id");--> statement-breakpointCREATE INDEX IF NOT EXISTS "attendance_summary_student_idx" ON "attendance_summary" USING btree ("student_id");--> statement-breakpointCREATE INDEX IF NOT EXISTS "attendance_summary_tenant_idx" ON "attendance_summary" USING btree ("tenant_id");--> statement-breakpointDO $$ BEGIN

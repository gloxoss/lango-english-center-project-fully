...
**Status: PASS** · Module: `alumni` · Source: [`src/app/[locale]/(alumni-portal)/alumni/profile/page.tsx`](<../../../../../src/app/[locale]/(alumni-portal)/alumni/profile/page.tsx>)
...
|---|---|---|---|
| Pass B | alumni | `/alumni/profile` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · alumni · fr · `/alumni/profile`

![alumni fr](../../shots/B__alumni-fr-__alumni__profile.jpg)

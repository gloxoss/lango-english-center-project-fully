...
**Status: PASS** · Module: `alumni` · Source: [`src/app/[locale]/(alumni-portal)/alumni/mentoring/page.tsx`](<../../../../../src/app/[locale]/(alumni-portal)/alumni/mentoring/page.tsx>)
...
|---|---|---|---|
| Pass B | alumni | `/alumni/mentoring` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · alumni · fr · `/alumni/mentoring`

![alumni fr](../../shots/B__alumni-fr-__alumni__mentoring.jpg)

...
**Status: PASS** · Module: `alumni` · Source: [`src/app/[locale]/(alumni-portal)/alumni/records/page.tsx`](<../../../../../src/app/[locale]/(alumni-portal)/alumni/records/page.tsx>)
...
|---|---|---|---|
| Pass B | alumni | `/alumni/records` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · alumni · fr · `/alumni/records`

![alumni fr](../../shots/B__alumni-fr-__alumni__records.jpg)

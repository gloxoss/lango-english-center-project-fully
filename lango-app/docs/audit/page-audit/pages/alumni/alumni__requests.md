...
**Status: PASS** · Module: `alumni` · Source: [`src/app/[locale]/(alumni-portal)/alumni/requests/page.tsx`](<../../../../../src/app/[locale]/(alumni-portal)/alumni/requests/page.tsx>)
...
|---|---|---|---|
| Pass B | alumni | `/alumni/requests` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · alumni · fr · `/alumni/requests`

![alumni fr](../../shots/B__alumni-fr-__alumni__requests.jpg)

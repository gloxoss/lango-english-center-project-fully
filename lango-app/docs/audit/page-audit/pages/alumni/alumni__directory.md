...
**Status: PASS** · Module: `alumni` · Source: [`src/app/[locale]/(alumni-portal)/alumni/directory/page.tsx`](<../../../../../src/app/[locale]/(alumni-portal)/alumni/directory/page.tsx>)
...
|---|---|---|---|
| Pass B | alumni | `/alumni/directory` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · alumni · fr · `/alumni/directory`

![alumni fr](../../shots/B__alumni-fr-__alumni__directory.jpg)

...
**Status: PASS** · Module: `alumni` · Source: [`src/app/[locale]/(alumni-portal)/alumni/events/page.tsx`](<../../../../../src/app/[locale]/(alumni-portal)/alumni/events/page.tsx>)
...
|---|---|---|---|
| Pass B | alumni | `/alumni/events` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · alumni · fr · `/alumni/events`

![alumni fr](../../shots/B__alumni-fr-__alumni__events.jpg)

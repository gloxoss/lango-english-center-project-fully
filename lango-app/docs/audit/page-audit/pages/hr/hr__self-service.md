...
**Status: NEEDS FIX (P1)** · Module: `hr` · Source: [`src/app/[locale]/(dashboard)/dashboard/hr/self-service/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/hr/self-service/page.tsx>)
...
|---|---|---|---|---|
| [S-38](../../findings/S-38.md) | P1 | HR self-service locked for every employee | Grant `payroll.self.read` to employee roles; only show "not an employee" for `error.code === NOT_AN_EMPLOYEE`; hide just the failing section otherwise. | STILL OPEN |

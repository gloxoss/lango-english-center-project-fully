...
Guard: `requireServerPage` · capability `inventory.issue.manage`
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/inventory/issues` | expected: → /fr/dashboard/settings/entitlements (add-on off or access denied, correct gating) |
| Pass B | school_admin | `/dashboard/inventory/issues` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/inventory/issues`

![school_admin fr](../../shots/A__school_admin-fr-inventory__issues.jpg)

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · school_admin · fr · `/dashboard/inventory/issues`

![school_admin fr](../../shots/B__school_admin-fr-inventory__issues.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/inventory/issues" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

# `/dashboard/portals/librarian/policies`
...
|---|---|---|---|
| Pass B | librarian | `/dashboard/portals/librarian/policies` | **S-32**: → /fr (public site) |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · librarian · fr · `/dashboard/portals/librarian/policies`

![librarian fr](../../shots/B__librarian-fr-portals__librarian__policies.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/portals/librarian/policies" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs librarian r.txt`

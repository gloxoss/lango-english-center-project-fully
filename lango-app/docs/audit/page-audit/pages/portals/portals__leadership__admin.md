...
|---|---|---|---|---|
| [S-22](../../findings/done/S-22.md) | P2 | Leadership admin calls HR API when HR add-on is off | Check the add-on first; hide that section. | Not re-checked since the sweep. |

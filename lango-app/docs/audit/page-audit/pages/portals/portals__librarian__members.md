# `/dashboard/portals/librarian/members`

**Status: PASS** · Module: `portals` · Source: [`src/app/[locale]/(dashboard)/dashboard/portals/librarian/members/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/portals/librarian/members/page.tsx>)
...
|---|---|---|---|
| Pass B | librarian | `/dashboard/portals/librarian/members` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · librarian · fr · `/dashboard/portals/librarian/members`

![librarian fr](../../shots/B__librarian-fr-portals__librarian__members.jpg)

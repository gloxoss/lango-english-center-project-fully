...
**Status: PASS** · Module: `portals` · Source: [`src/app/[locale]/(dashboard)/dashboard/portals/guard/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/portals/guard/page.tsx>)
...
|---|---|---|---|
| Pass B | guard | `/dashboard/portals/guard` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · guard · fr · `/dashboard/portals/guard`

![guard fr](../../shots/B__guard-fr-portals__guard.jpg)

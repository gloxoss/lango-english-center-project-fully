...
**Status: PASS** · Module: `portals` · Source: [`src/app/[locale]/(dashboard)/dashboard/portals/guard/incidents/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/portals/guard/incidents/page.tsx>)

Guard: `requireServerPage` · capability `guard.incidents.manage`
...
|---|---|---|---|
| Pass B | guard | `/dashboard/portals/guard/incidents` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · guard · fr · `/dashboard/portals/guard/incidents`

![guard fr](../../shots/B__guard-fr-portals__guard__incidents.jpg)

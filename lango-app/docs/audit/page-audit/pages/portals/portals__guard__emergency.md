...
**Status: PASS** · Module: `portals` · Source: [`src/app/[locale]/(dashboard)/dashboard/portals/guard/emergency/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/portals/guard/emergency/page.tsx>)

Guard: `requireServerPage` · capability `guard.portal.use`
...
|---|---|---|---|
| Pass B | guard | `/dashboard/portals/guard/emergency` | ok |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · guard · fr · `/dashboard/portals/guard/emergency`

![guard fr](../../shots/B__guard-fr-portals__guard__emergency.jpg)

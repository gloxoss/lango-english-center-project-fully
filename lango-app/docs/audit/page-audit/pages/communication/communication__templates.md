...
**Status: NEEDS FIX (P1)** · Module: `communication` · Source: [`src/app/[locale]/(dashboard)/dashboard/communication/templates/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/communication/templates/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/communication/templates` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/communication/templates`

![school_admin fr](../../shots/A__school_admin-fr-communication__templates.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/communication/templates" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

...
|---|---|---|---|---|
| [S-2](../../findings/S-2.md) | P1 | SMS reminders page shows a false all-clear | Add a dedicated at-risk endpoint (full list, class filter) and consume it. Show an error, never "au vert", when the fetch fails. Make simulation vs real sending unambiguous. | Not re-checked since the sweep. |

...
**Status: PASS** · Module: `communication` · Source: [`src/app/[locale]/(dashboard)/dashboard/communication/broadcast/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/communication/broadcast/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/communication/broadcast` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/communication/broadcast`

![school_admin fr](../../shots/A__school_admin-fr-communication__broadcast.jpg)

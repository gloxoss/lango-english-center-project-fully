...
|---|---|---|---|---|
| [S-5](../../findings/S-5.md) | P1 | Report card generator: "Moyenne générale 0.00/20" with no marks, print enabled | Show "—" and disable print/PDF when no subject is graded. Add a term selector passing `examTermId`. | Not re-checked since the sweep. |

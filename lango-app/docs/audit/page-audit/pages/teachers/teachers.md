...
**Status: PASS** · Module: `teachers` · Source: [`src/app/[locale]/(dashboard)/dashboard/teachers/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/teachers/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/teachers` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/teachers`

![school_admin fr](../../shots/A__school_admin-fr-teachers.jpg)

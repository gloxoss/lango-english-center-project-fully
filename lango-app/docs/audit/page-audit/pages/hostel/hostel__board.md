...
**Status: NEEDS FIX (P1)** · Module: `hostel` · Source: [`src/app/[locale]/(dashboard)/dashboard/hostel/board/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/hostel/board/page.tsx>)

**Progress (2026-09-23):** S-32 PARTIAL · S-54 OPEN
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/hostel/board` | expected: → /fr/dashboard/settings/entitlements (add-on off or access denied, correct gating) |
| Pass B | school_admin | `/dashboard/hostel/board` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/hostel/board`

![school_admin fr](../../shots/A__school_admin-fr-hostel__board.jpg)

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · school_admin · fr · `/dashboard/hostel/board`

![school_admin fr](../../shots/B__school_admin-fr-hostel__board.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/hostel/board" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

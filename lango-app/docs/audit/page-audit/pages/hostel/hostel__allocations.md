...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/hostel/allocations` | expected: → /fr/dashboard/settings/entitlements (add-on off or access denied, correct gating) |
| Pass B | school_admin | `/dashboard/hostel/allocations` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/hostel/allocations`

![school_admin fr](../../shots/A__school_admin-fr-hostel__allocations.jpg)

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · school_admin · fr · `/dashboard/hostel/allocations`

![school_admin fr](../../shots/B__school_admin-fr-hostel__allocations.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/hostel/allocations" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

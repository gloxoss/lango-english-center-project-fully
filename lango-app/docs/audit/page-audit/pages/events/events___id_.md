...
**Status: NEEDS FIX (P2)** · Module: `events` · Source: [`src/app/[locale]/(dashboard)/dashboard/events/[id]/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/events/[id]/page.tsx>)
...
|---|---|---|---|---|
| [S-52](../../findings/S-52.md) | P2 | Parents and students can read any event by ID (drafts, staff-only) | Non-staff: only published events whose audience includes them, else 404; route them to a read-only family view. | STILL OPEN |

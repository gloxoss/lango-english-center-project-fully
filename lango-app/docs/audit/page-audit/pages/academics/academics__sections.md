...
**Status: NEEDS FIX (P1)** · Module: `academics` · Source: [`src/app/[locale]/(dashboard)/dashboard/academics/sections/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/academics/sections/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/academics/sections` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/academics/sections`

![school_admin fr](../../shots/A__school_admin-fr-academics__sections.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/academics/sections" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

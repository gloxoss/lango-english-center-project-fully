...
|---|---|---|---|---|
| [S-4](../../findings/S-4.md) | P1 | Empty checks scored as 100 % (readiness, attendance, collection, SMS) | Zero denominator => "À configurer / Bloqué", counted as 0 in the overall score. | Not re-checked since the sweep. |

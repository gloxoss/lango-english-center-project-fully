...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/academics/subjects` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/academics/subjects`

![school_admin fr](../../shots/A__school_admin-fr-academics__subjects.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/academics/subjects" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

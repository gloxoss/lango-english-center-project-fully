...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/academics/grading/policies` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/academics/grading/policies`

![school_admin fr](../../shots/A__school_admin-fr-academics__grading__policies.jpg)

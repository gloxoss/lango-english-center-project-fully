...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/academics/calendar` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/academics/calendar`

![school_admin fr](../../shots/A__school_admin-fr-academics__calendar.jpg)

...
**Status: PASS** · Module: `academics` · Source: [`src/app/[locale]/(dashboard)/dashboard/academics/evaluations/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/academics/evaluations/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/academics/evaluations` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/academics/evaluations`

![school_admin fr](../../shots/A__school_admin-fr-academics__evaluations.jpg)

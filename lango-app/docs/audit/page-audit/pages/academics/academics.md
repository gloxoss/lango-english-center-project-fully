...
**Status: NEEDS FIX (P2)** · Module: `academics` · Source: [`src/app/[locale]/(dashboard)/dashboard/academics/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/academics/page.tsx>)
...
|---|---|---|---|---|
| [S-16](../../findings/S-16.md) | P2 | Academics index redirects the director to the teacher schedule | Land on an academics overview or classes. | Not re-checked since the sweep. |

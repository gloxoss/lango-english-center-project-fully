...
**Status: NEEDS FIX (P1)** · Module: `academics` · Source: [`src/app/[locale]/(dashboard)/dashboard/academics/assessment/exam-master/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/academics/assessment/exam-master/page.tsx>)

**Progress (2026-09-25):** S-32 PARTIAL · S-13 PARTIAL
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/academics/assessment/exam-master` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/academics/assessment/exam-master`

![school_admin fr](../../shots/A__school_admin-fr-academics__assessment__exam-master.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/academics/assessment/exam-master" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

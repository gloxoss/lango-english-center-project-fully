...
Guard: `requireServerPage` · capability `settings.numbering.manage`
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/settings/numbering` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/settings/numbering`

![school_admin fr](../../shots/A__school_admin-fr-settings__numbering.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/settings/numbering" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

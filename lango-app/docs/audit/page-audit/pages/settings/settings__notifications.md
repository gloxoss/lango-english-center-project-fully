...
**Status: NEEDS FIX (P1)** · Module: `settings` · Source: [`src/app/[locale]/(dashboard)/dashboard/settings/notifications/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/settings/notifications/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/settings/notifications` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/settings/notifications`

![school_admin fr](../../shots/A__school_admin-fr-settings__notifications.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/settings/notifications" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

...
**Status: NEEDS FIX (P1)** · Module: `settings` · Source: [`src/app/[locale]/(dashboard)/dashboard/settings/custom-fields/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/settings/custom-fields/page.tsx>)
...
Guard: `requireServerPage` · capability `settings.custom_field.manage`
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/settings/custom-fields` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/settings/custom-fields`

![school_admin fr](../../shots/A__school_admin-fr-settings__custom-fields.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/settings/custom-fields" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

...
|---|---|---|---|---|
| [S-18](../../findings/S-18.md) | P1 | Header claims CNDP compliance on every page; the school has not filed | Show the real CNDP status (Non déposé / Déposé / Approuvé) or remove the badge. Hide it for parents and students. | Not re-checked since the sweep. |

...
**Status: NEEDS FIX (P1)** · Module: `settings` · Source: [`src/app/[locale]/(dashboard)/dashboard/settings/accounting-defaults/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/settings/accounting-defaults/page.tsx>)
...
Guard: `requireServerPage` · capability `settings.finance_mapping.manage`
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/settings/accounting-defaults` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/settings/accounting-defaults`

![school_admin fr](../../shots/A__school_admin-fr-settings__accounting-defaults.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/settings/accounting-defaults" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

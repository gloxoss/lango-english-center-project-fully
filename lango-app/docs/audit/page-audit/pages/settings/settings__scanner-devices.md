...
**Status: PASS** · Module: `settings` · Source: [`src/app/[locale]/(dashboard)/dashboard/settings/scanner-devices/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/settings/scanner-devices/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/settings/scanner-devices` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/settings/scanner-devices`

![school_admin fr](../../shots/A__school_admin-fr-settings__scanner-devices.jpg)

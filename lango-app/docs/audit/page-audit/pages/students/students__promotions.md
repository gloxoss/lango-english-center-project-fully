...
**Status: NEEDS FIX (P1)** · Module: `students` · Source: [`src/app/[locale]/(dashboard)/dashboard/students/promotions/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/students/promotions/page.tsx>)

**Progress (2026-09-26):** S-9 DONE · S-32 PARTIAL
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/students/promotions` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/students/promotions`

![school_admin fr](../../shots/A__school_admin-fr-students__promotions.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/students/promotions" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

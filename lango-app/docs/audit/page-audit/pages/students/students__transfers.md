...
**Status: PASS** · Module: `students` · Source: [`src/app/[locale]/(dashboard)/dashboard/students/transfers/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/students/transfers/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/students/transfers` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/students/transfers`

![school_admin fr](../../shots/A__school_admin-fr-students__transfers.jpg)

# `/dashboard/certificates/requests`
...
**Progress (2026-09-24):** S-6 DONE · S-32 PARTIAL · S-42 DONE
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/certificates/requests` | expected: → /fr/dashboard/settings/entitlements (add-on off or access denied, correct gating) |
| Pass B | school_admin | `/dashboard/certificates/requests` | **S-6**: console: IntlError: MISSING_MESSAGE: Could not resolve `Certificates.btnNewRequest` in messages for locale `fr`. |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/certificates/requests`

![school_admin fr](../../shots/A__school_admin-fr-certificates__requests.jpg)

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · school_admin · fr · `/dashboard/certificates/requests`

![school_admin fr](../../shots/B__school_admin-fr-certificates__requests.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/certificates/requests" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

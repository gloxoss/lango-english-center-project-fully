# `/dashboard/certificates/jobs`

**Status: NEEDS FIX (P1)** · Module: `certificates` · Source: [`src/app/[locale]/(dashboard)/dashboard/certificates/jobs/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/certificates/jobs/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/certificates/jobs` | expected: → /fr/dashboard/settings/entitlements (add-on off or access denied, correct gating) |
| Pass B | school_admin | `/dashboard/certificates/jobs` | **S-6**: console: IntlError: MISSING_MESSAGE: Could not resolve `Certificates.batchIssuanceTitle` in messages for locale `fr`. |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/certificates/jobs`

![school_admin fr](../../shots/A__school_admin-fr-certificates__jobs.jpg)

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · school_admin · fr · `/dashboard/certificates/jobs`

![school_admin fr](../../shots/B__school_admin-fr-certificates__jobs.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/certificates/jobs" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

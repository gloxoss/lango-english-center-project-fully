...
**Status: FIXED, pending re-sweep** · Module: `certificates` · Source: [`src/app/[locale]/(dashboard)/dashboard/certificates/issued/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/certificates/issued/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/certificates/issued` | expected: → /fr/dashboard/settings/entitlements (add-on off or access denied, correct gating) |
| Pass B | school_admin | `/dashboard/certificates/issued` | **S-6**: console: IntlError: MISSING_MESSAGE: Could not resolve `Certificates.issuedCertificatesTitle` in messages for locale `fr`. |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/certificates/issued`

![school_admin fr](../../shots/A__school_admin-fr-certificates__issued.jpg)

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · school_admin · fr · `/dashboard/certificates/issued`

![school_admin fr](../../shots/B__school_admin-fr-certificates__issued.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/certificates/issued" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

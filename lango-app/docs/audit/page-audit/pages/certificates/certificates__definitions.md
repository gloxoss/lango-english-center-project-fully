# `/dashboard/certificates/definitions`

**Status: FIXED, pending re-sweep** · Module: `certificates` · Source: [`src/app/[locale]/(dashboard)/dashboard/certificates/definitions/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/certificates/definitions/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/certificates/definitions` | expected: → /fr/dashboard/settings/entitlements (add-on off or access denied, correct gating) |
| Pass B | school_admin | `/dashboard/certificates/definitions` | **S-6**: console: IntlError: MISSING_MESSAGE: Could not resolve `Certificates.btnNewDefinition` in messages for locale `fr`. |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/certificates/definitions`

![school_admin fr](../../shots/A__school_admin-fr-certificates__definitions.jpg)

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · school_admin · fr · `/dashboard/certificates/definitions`

![school_admin fr](../../shots/B__school_admin-fr-certificates__definitions.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/certificates/definitions" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

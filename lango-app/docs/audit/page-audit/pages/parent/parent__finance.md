...
**Progress (2026-09-23):** S-45 OPEN · S-47 OPEN · S-48 OPEN
...
|---|---|---|---|
| Pass B | parent | `/dashboard/parent/finance` | **S-44**: 403 /api/settings/branches |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · parent · fr · `/dashboard/parent/finance`

![parent fr](../../shots/B__parent-fr-parent__finance.jpg)
...
- [ ] **S-48 (P3)** Parent amounts unformatted ("24000 MAD")
  - [ ] Use it.
  - [ ] Accept: "24 000 MAD".
- [ ] Re-run this page: `echo "/dashboard/parent/finance" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs parent r.txt`

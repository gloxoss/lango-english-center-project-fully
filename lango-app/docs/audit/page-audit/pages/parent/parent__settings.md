...
**Status: NEEDS FIX (P2)** · Module: `parent` · Source: [`src/app/[locale]/(dashboard)/dashboard/parent/settings/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/parent/settings/page.tsx>)
...
|---|---|---|---|
| Pass B | parent | `/dashboard/parent/settings` | **S-44**: 403 /api/settings/branches |

## Screenshots

**Pass B · seeded audit DB, all add-ons, 2026-09-23** · parent · fr · `/dashboard/parent/settings`

![parent fr](../../shots/B__parent-fr-parent__settings.jpg)
...
- [ ] **S-47 (P3)** Empty subtitle rendered as "—" (teacher class card, parent child picker)
  - [ ] Fix both components.
  - [ ] Accept: No lone dash.
- [ ] Re-run this page: `echo "/dashboard/parent/settings" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs parent r.txt`

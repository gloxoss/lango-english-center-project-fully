...
**Status: NEEDS FIX (P1)** · Module: `finance` · Source: [`src/app/[locale]/(dashboard)/dashboard/finance/statements/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/finance/statements/page.tsx>)
...
|---|---|---|---|
| Pass A | accountant | `/dashboard/finance/statements` | ok |
| Pass A | school_admin | `/dashboard/finance/statements` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · accountant · fr · `/dashboard/finance/statements`

![accountant fr](../../shots/A__accountant-fr-finance__statements.jpg)

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/finance/statements`

![school_admin fr](../../shots/A__school_admin-fr-finance__statements.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/finance/statements" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs accountant r.txt`

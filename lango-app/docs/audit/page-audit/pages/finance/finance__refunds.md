...
**Status: NEEDS FIX (P1)** · Module: `finance` · Source: [`src/app/[locale]/(dashboard)/dashboard/finance/refunds/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/finance/refunds/page.tsx>)
...
|---|---|---|---|
| Pass A | accountant | `/dashboard/finance/refunds` | ok |
| Pass A | school_admin | `/dashboard/finance/refunds` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · accountant · fr · `/dashboard/finance/refunds`

![accountant fr](../../shots/A__accountant-fr-finance__refunds.jpg)

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/finance/refunds`

![school_admin fr](../../shots/A__school_admin-fr-finance__refunds.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/finance/refunds" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs accountant r.txt`

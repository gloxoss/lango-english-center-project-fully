# `/dashboard/attendance/qr-reports`

**Status: PASS** · Module: `attendance` · Source: [`src/app/[locale]/(dashboard)/dashboard/attendance/qr-reports/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/attendance/qr-reports/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/attendance/qr-reports` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/attendance/qr-reports`

![school_admin fr](../../shots/A__school_admin-fr-attendance__qr-reports.jpg)

# `/dashboard/attendance/badges`

**Status: NEEDS FIX (P1)** · Module: `attendance` · Source: [`src/app/[locale]/(dashboard)/dashboard/attendance/badges/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/attendance/badges/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/attendance/badges` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/attendance/badges`

![school_admin fr](../../shots/A__school_admin-fr-attendance__badges.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/attendance/badges" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

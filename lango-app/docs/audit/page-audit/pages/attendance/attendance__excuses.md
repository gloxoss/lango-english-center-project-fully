...
**Status: NEEDS FIX (P1)** · Module: `attendance` · Source: [`src/app/[locale]/(dashboard)/dashboard/attendance/excuses/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/attendance/excuses/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/attendance/excuses` | ok |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/attendance/excuses`

![school_admin fr](../../shots/A__school_admin-fr-attendance__excuses.jpg)
...
- [ ] Re-run this page: `echo "/dashboard/attendance/excuses" > r.txt && AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs school_admin r.txt`

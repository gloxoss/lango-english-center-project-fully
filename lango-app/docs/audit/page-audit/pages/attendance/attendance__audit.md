...
**Status: PASS** · Module: `attendance` · Source: [`src/app/[locale]/(dashboard)/dashboard/attendance/audit/page.tsx`](<../../../../../src/app/[locale]/(dashboard)/dashboard/attendance/audit/page.tsx>)
...
|---|---|---|---|
| Pass A | school_admin | `/dashboard/attendance/audit` | expected: harness: warm-up request aborted by the measured reload (page renders its data) |

## Screenshots

**Pass A · main DB (:3111/:3222), 2026-09-22/23** · school_admin · fr · `/dashboard/attendance/audit`

![school_admin fr](../../shots/A__school_admin-fr-attendance__audit.jpg)

...
|---|---|---|---|
| Pass C | anonymous | `/atlas/news` | ok |
| Pass C | anonymous | `/atlas/news` | ok |

## Screenshots

**Pass C · detail + public pages, 2026-09-23** · anonymous · fr · `/atlas/news`

![anonymous fr](../../shots/C__anonymous-fr-__atlas__news.jpg)

**Pass C · public site after publishing content** · anonymous · fr · `/atlas/news`

![anonymous fr](../../shots/C-site__anonymous-fr-__atlas__news.jpg)
...
- [ ] Re-run this page: `echo "/atlas/news" > r.txt && NO_LOGIN=1 AUDIT_BASE=http://localhost:3333 node scripts/visual-sweep.mjs anonymous r.txt`

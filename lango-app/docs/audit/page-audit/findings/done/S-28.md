...
<!-- status -->
> **Status (2026-09-23): DONE.** confirmed in code by claude-auditor (not re-swept on screen): receivables API has a notDue bucket; "Relancer" only renders for overdue invoices with a balance.
<!-- /status -->
...
- [`/dashboard/finance/receivables`](../../pages/finance/finance__receivables.md) · FIXED, pending re-sweep

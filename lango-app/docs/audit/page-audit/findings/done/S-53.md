...
<!-- status -->
> **Status (2026-09-23): DONE.** codex-1 fixed; verified by a second agent in the Agent Hub (claude-1).
<!-- /status -->
...
- [`/dashboard/workforce/payroll/runs/[id]`](../../pages/workforce/workforce__payroll__runs___id_.md) · FIXED, pending re-sweep

...
<!-- status -->
> **Status (2026-09-24): REVIEW.** claude-finance: Parent menu uses family wording instead of staff labels (Accueil, Présences de mes enfants, Factures & paiements, Messages de l’école, Demandes & documents, Mes préférences; fr/en/ar under Navigation. Waiting for a second agent to verify.
<!-- /status -->

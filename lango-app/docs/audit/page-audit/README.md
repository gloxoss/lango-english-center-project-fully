...
| [S-7](findings/S-7.md) | P1 | ~1 375 hardcoded French UI strings bypass translation (Arabic UI stays French) | 0 + global | PARTIAL |
...
| [V-1](findings/done/V-1.md) | P1 | Finance home shows 6 000 MAD overdue, every other screen shows 3 000 | 1 | DONE |
...
| [S-12](findings/done/S-12.md) | P2 | Timetable: duplicate generate buttons, 2-hour grid | 1 | DONE |
| [S-13](findings/S-13.md) | P2 | Exam planning exists twice | 2 | PARTIAL |
| [S-14](findings/done/S-14.md) | P2 | Sidebar lists add-on modules the tenant has not enabled | 0 + global | DONE |
| [S-15](findings/S-15.md) | P2 | Two director dashboards with overlapping KPIs; IGP unexplained | 3 | PARTIAL |
...
| [S-22](findings/done/S-22.md) | P2 | Leadership admin calls HR API when HR add-on is off | 1 | DONE |
| [S-23](findings/S-23.md) | P2 | Audit log shows internal names and writes rows on view | 1 | PARTIAL |
| [S-24](findings/S-24.md) | P2 | Three matricule formats in one tenant | 2 | PARTIAL |
| [S-25](findings/done/S-25.md) | P2 | Header shows a fake identity when the session call is slow | 0 + global | DONE |
| [S-26](findings/S-26.md) | P2 | Settings page: wrong "Configuré" state, raw English actions, spec codes | 1 | PARTIAL |
...
| [S-33](findings/S-33.md) | P2 | "{count} demandes" rendered without a value | 1 | PARTIAL |
| [S-34](findings/S-34.md) | P2 | Student photos: broken files counted, upload hint names a format nobody has | 1 | PARTIAL |
| [S-36](findings/S-36.md) | P2 | Invoices on phone: desktop table squeezed, status off-screen | 1 | PARTIAL |
...
| [S-44](findings/done/S-44.md) | P2 | Staff campus switcher renders for parents, students and super admin (403 on every page) | 0 + global | DONE |
| [S-45](findings/S-45.md) | P2 | Parent sidebar reuses staff labels | 7 | PARTIAL |
| [S-46](findings/S-46.md) | P2 | Seed data contradicts itself (library loans, live-class dates) | 3 | PARTIAL |
...
| [S-54](findings/done/S-54.md) | P2 | Expired hostel stays stay "checked_in" forever | 5 | DONE |
| [S-56](findings/done/S-56.md) | P2 | Inventory quantities read as thousands ("+12.000" for 12) | 3 | DONE |
| [S-29](findings/done/S-29.md) | P3 | Overdue totals agree everywhere except the finance home (confirms V-1) | 1 | DONE |
| [S-47](findings/S-47.md) | P3 | Empty subtitle rendered as "—" (teacher class card, parent child picker) | 8 | PARTIAL |
| [S-48](findings/done/S-48.md) | P3 | Parent amounts unformatted ("24000 MAD") | 2 | DONE |
| [S-49](findings/done/S-49.md) | P3 | Super-admin dashboard text glitches | 1 | DONE |
| [S-50](findings/done/S-50.md) | P3 | Transport allocations list without React keys | 2 | DONE |
| [S-51](findings/done/S-51.md) | P3 | Cards "Émissions récentes" never shows the recipient | 1 | DONE |
| [S-55](findings/S-55.md) | P3 | Public school site: no menu, home ignores news, low-contrast hero | 9 | PARTIAL |
| [S-57](findings/S-57.md) | P3 | Raw enum values, two money formats, stale "current" year, overlapping widget | 6 | PARTIAL |
